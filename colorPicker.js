...
class colorPicker extends baseElement {
    ...
    <div class="row">
        <div class="col-12">
            <input class="w-20" type="color" bs-type="{{if(options.ms.type)}}{{ms.type}}{{#else}}text{{/if}}" rel="txtTooltip" title=${t('colpickerttip1')} data-bs-toggle="tooltip" data-bs-placement="bottom"
                   id="{{modal.id}}_{{ms.no}}" 
