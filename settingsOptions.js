...
class MiscOpt {
    ...
    htmlTemplate = `
      ...
      -->
      <!-- showAddToChatBtn checkbox removed intentionally — toggle this setting directly in
           appconfig.v*.json (APPDATA) by setting "showAddToChatBtn": true/false -->
      <!--
      <div id="showAddToChatBtnDiv" class="form-check pb-3">
        <input class="form-check-input" type="checkbox" id="showAddToChatBtn"
          name="showAddToChatBtn">
        <label class="form-check-label" for="showAddToChatBtn">Show "Add dataset columns to chat" button on the output toolbar (Applied after application restart)</label>
      </div>
      -->
      <!-- showAddDataframeToChatBtn checkbox removed intentionally — toggle this setting directly in
           appconfig.v*.json (APPDATA) by setting "showAddDataframeToChatBtn": true/false -->
      <!--
      <div id="showAddDataframeToChatBtnDiv" class="form-check pb-3">
        <input class="form-check-input" type="checkbox" id="showAddDataframeToChatBtn"
          name="showAddDataframeToChatBtn">
        <label class="form-check-label" for="showAddDataframeToChatBtn">Show "Add dataframe to chat" button on the output toolbar (Applied after application restart)</label>
      </div>
      -->
      <!-- showAddAllOutputToChatBtn checkbox removed intentionally — toggle this setting directly in
           appconfig.v*.json (APPDATA) by setting "showAddAllOutputToChatBtn": true/false -->
      <!--
      <div id="showAddAllOutputToChatBtnDiv" class="form-check pb-3">
        <input class="form-check-input" type="checkbox" id="showAddAllOutputToChatBtn"
          name="showAddAllOutputToChatBtn">
        <label class="form-check-label" for="showAddAllOutputToChatBtn">Show "Add all output to chat" button on the output toolbar (Applied after application restart)</label>
      </div>
      -->
